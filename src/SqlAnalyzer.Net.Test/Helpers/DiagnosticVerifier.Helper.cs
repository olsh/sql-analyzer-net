...
namespace SqlAnalyzer.Net.Test
{
    ...
    public abstract partial class DiagnosticVerifier
    {
        ...
        private static readonly MetadataReference DapperReference =
            MetadataReference.CreateFromFile(typeof(Dapper.DbString).Assembly.Location);
        ...
        private static readonly MetadataReference SystemDataSqlClientReference =
        ...
        /// <summary>
        /// Given classes in the form of strings, their language, and an IDiagnosticAnalyzer to apply to it, return the diagnostics
